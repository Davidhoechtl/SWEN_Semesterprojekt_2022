...
namespace MTCG.DAL
{
    ...
    internal class NpgSqlUnitOfWorkDatabase : IUnitOfWork
    {
        public NpgSqlUnitOfWorkDatabase(IDbConnection dbConnection)
        {
        ...
        {
            NpgsqlCommand cmd = new NpgsqlCommand(statement, dbConnection, transaction);
